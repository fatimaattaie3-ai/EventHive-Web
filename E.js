...
const aboutUs = [
  {
    name: "John Doe",
    role: "Founder & CEO",
    bio: "John is the founder and CEO of EventHive, with over 10 years of experience in the event industry."
  },
  {
    name: "Jane Smith",
    role: "Marketing Director",
    bio: "Jane leads our marketing efforts and has a passion for creating engaging campaigns that connect with our audience."
  }
];



const links = [["discover","Discover"],["dashboard","Organizer"],["about","About Us"],["contact","Contact"]];
function renderAbout(){
  return `
  <div class="page-head" style="padding:40px 0;">
    <span class="eyebrow">Who we are</span>
    <h1>About EventHive</h1>
    <p style="color:var(--text-dim); max-width:520px; line-height:1.7; margin-top:10px;">
      EventHive is a platform built to help students at AUW discover and join
      workshops, auditions, and webinars happening around campus. Our goal is
      to make it easier to find events that match your interests, all in one place.
    </p>
  </div>
  `;
}
...
function renderContact(){
  ...
  <div class="page-head" style="padding:40px 0;">
    ...
    <h1>Contact us</h1>
    <p style="color:var(--text-dim); margin-top:10px;">Email: hello@eventhive.com</p>
    <p style="color:var(--text-dim);">Location: AUW Campus, Chittagong</p>
  </div>
  `;
}
